...
import GalleryProduct from '../components/details/GalleryProduct.vue';
...
async function getProduct() {
   try {
      ...
      itemProduct.value = response.data.data;
   } catch (error) {
      console.log(error);
   }
}
      ...
      <div class="container p-2 mx-auto my-10 max-w-7xl">
         <div class="flex flex-row flex-wrap py-4">
            <main role="main" class="w-full px-4 pt-1 sm:w-2/3 md:w-2/3">
               ...
               <p class="text-gray-500">{{ itemProduct.subtitle }}</p>
               <!-- Gallery -->
               <GalleryProduct />
               <section class="" id="orders">
                  <h1 class="mt-8 mb-3 text-lg font-semibold">About</h1>
                  <div class="text-gray-500" v-html="itemProduct.description">
                  </div>
               </section>
            </main>
